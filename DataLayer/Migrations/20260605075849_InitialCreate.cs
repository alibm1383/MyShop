    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Samsung", 1100m, 5, "Samsung S25" },
                    { 2, "Apple", 1000m, 3, "Iphone 16" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "IsAdmin", "Password", "RegisteredDate" },
                values: new object[] { 1, "bakhtiarimoghadam1383@gmail.com", true, "Admin1234@", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
